...
#  port code 17 = standard 
#  port code 19 = deviant  

scenario = "visual_oddball_265";
active_buttons = 1;
button_codes = 1;
no_logfile = false;
...
write_codes = true; 
pulse_width = 10;
pcl_file = "visual_oddball_265.pcl";
...
trial_duration = 896;
	...
	stimulus_event {	
		picture default;
		deltat=244; #closest we can get, the duration is ~265ms
		code = "265 isi";  
	} event_isi_dev;
}deviant_trial;
