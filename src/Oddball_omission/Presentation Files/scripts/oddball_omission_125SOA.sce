...
#125 SOA
scenario = "omission_oddball_125SOA";
...
write_codes = true; 
pulse_width = 10;
pcl_file = "oddball_omission_125SOA.pcl";

begin;

# port codes:
# 3 = 1000 hz as a standard.
# 5 = silent tone as a deviant.

#Load the auditory stimuli:
#STD = 5 ms fade in 1000hz 40ms 5 ms fade out (total of 50ms tone)
